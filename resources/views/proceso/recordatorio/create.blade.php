...
<div class="card card-secondary">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('proceso.recordatorio.store', $proceso_id)}}" method="post" autocomplete="off">
            @csrf
            <div class="row mb-4">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{route('proceso.recordatorio.index', $proceso_id)}}" class="btn btn-secondary" role="button"
                        aria-label="Buscar">
                        {{'Cancelar'}}
                    </a>
