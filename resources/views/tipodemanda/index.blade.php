...
<div class="card card-secondary">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <form action="{{route('tipodemanda.index')}}" method="get">
        @csrf
              ...
              <td class="text-center">
                <form action="{{route('tipodemanda.destroy', $tipodemanda->id)}}" method="post">
                  ...
                  <div class="btn-group" role="group" aria-label="Acciones">
                    <a href="{{route('tipodemanda.show', $tipodemanda->id)}}" class="btn btn-info" role="button"
                      aria-label="Mostrar">
                      <i class="far fa-eye" aria-hidden="true"></i>
                    </a>
                    <a href="{{route('tipodemanda.edit', $tipodemanda->id)}}" class="btn btn-warning" aria-label="Editar">
