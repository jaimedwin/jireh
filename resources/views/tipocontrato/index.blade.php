...
<div class="card card-secondary">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <form action="{{route('tipocontrato.index')}}" method="get">
        @csrf
  ...
  <div class="card-body">
    <div class="row  mb-4">
      <div class="col-12">
        <a href="{{route('tipocontrato.create')}}" class="btn btn-primary" role="button" aria-label="Buscar">
              ...
              <td class="text-center">
                <form action="{{route('tipocontrato.destroy', $tipocontrato->id)}}" method="post">
                  ...
                  <div class="btn-group" role="group" aria-label="Acciones">
                    <a href="{{route('tipocontrato.show', $tipocontrato->id)}}" class="btn btn-info" role="button"
                      aria-label="Mostrar">
                      <i class="far fa-eye" aria-hidden="true"></i>
                    </a>
                    <a href="{{route('tipocontrato.edit', $tipocontrato->id)}}" class="btn btn-warning" aria-label="Editar">
  ...
  <div class="card-footer clearfix">
    <div class="float-right">{{$Tipocontratos->links()}}</div>
  </div>
</div>
@endsection