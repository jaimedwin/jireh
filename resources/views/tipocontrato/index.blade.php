...
<div class="card card-secondary">
	...
	<div class="card-header">
		...
		<div class="card-tools">
			<form action="{{route('tipocontrato.index')}}" method="get" autocomplete="off">
				@csrf
							...
							<td class="text-center">
								<form action="{{route('tipocontrato.destroy', $tipocontrato->id)}}" method="post">
									...
									<div class="btn-group" role="group" aria-label="Acciones">
										<a href="{{route('tipocontrato.show', $tipocontrato->id)}}" class="btn btn-info"
											role="button" aria-label="Mostrar">
											<i class="far fa-eye" aria-hidden="true"></i>
										</a>
										<a href="{{route('tipocontrato.edit', $tipocontrato->id)}}"
