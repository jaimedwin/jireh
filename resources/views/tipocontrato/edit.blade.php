...
<div class="card card-secondary">
    ...
    <div class="card-body">
        ...
        <form action="{{route('tipocontrato.update', $tipocontrato->id)}}" method="post" autocomplete="off">
            @csrf
            @method('PUT')
            <div class="row mb-4">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{route('tipocontrato.index')}}" class="btn btn-secondary" role="button" aria-label="Cancelar">
                        {{'Cancelar'}}
                    </a>
