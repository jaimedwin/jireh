...
<div class="card card-secondary">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('tipodocumentoidentificacion.store')}}" method="post" autocomplete="off">
            @csrf
            <div class="row mb-4">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{route('tipodocumentoidentificacion.index')}}" class="btn btn-secondary" role="button" aria-label="Buscar">
                        {{'Cancelar'}}
                    </a>
