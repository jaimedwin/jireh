...
<div class="card card-secondary">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <form action="{{route('ciudadproceso.index')}}" method="get">
        @csrf
              ...
              <td class="text-center">
                <form action="{{route('ciudadproceso.destroy', $ciudadproceso->id)}}" method="post">
                  ...
                  <div class="btn-group" role="group" aria-label="Acciones">
                    <a href="{{route('ciudadproceso.show', $ciudadproceso->id)}}" class="btn btn-info" role="button"
                      aria-label="Mostrar">
                      <i class="far fa-eye" aria-hidden="true"></i>
                    </a>
                    <a href="{{route('ciudadproceso.edit', $ciudadproceso->id)}}" class="btn btn-warning" aria-label="Editar">
