...
<div class="card card-secondary">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <form action="{{route('tipodocumento.index')}}" method="get">
        @csrf
              ...
              <td class="text-center">
                <form action="{{route('tipodocumento.destroy', $tipodocumento->id)}}" method="post">
                  ...
                  <div class="btn-group" role="group" aria-label="Acciones">
                    <a href="{{route('tipodocumento.show', $tipodocumento->id)}}" class="btn btn-info" role="button"
                      aria-label="Mostrar">
                      <i class="far fa-eye" aria-hidden="true"></i>
                    </a>
                    <a href="{{route('tipodocumento.edit', $tipodocumento->id)}}" class="btn btn-warning" aria-label="Editar">
