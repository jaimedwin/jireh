...
<div class="card card-secondary">
	...
	<div class="card-header">
		...
		<div class="card-tools">
			<form action="{{route('fondodepension.index')}}" method="get" autocomplete="off">
				@csrf
							...
							<td class="text-center">
								<form action="{{route('fondodepension.destroy', $fondodepension->id)}}" method="post">
									...
									<div class="btn-group" role="group" aria-label="Acciones">
										<a href="{{route('fondodepension.show', $fondodepension->id)}}"
											class="btn btn-info" role="button" aria-label="Mostrar">
											<i class="far fa-eye" aria-hidden="true"></i>
										</a>
										<a href="{{route('fondodepension.edit', $fondodepension->id)}}"
