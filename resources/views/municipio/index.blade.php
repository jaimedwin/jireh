...
<div class="card card-secondary">
	...
	<div class="card-header">
		...
		<div class="card-tools">
			<form action="{{route('municipio.index')}}" method="get" autocomplete="off">
				@csrf
	...
	<div class="card-body">
		<div class="row  mb-4">
			<div class="col-12">
				<a href="{{route('municipio.create')}}" class="btn btn-primary" role="button" aria-label="Buscar">
					<i class="fas fa-plus-square"></i>
					{{'Crear nuevo lugar de expedición'}}
				</a>
			</div>
		</div>
	...
	<div class="card-footer clearfix">
		<div class="float-right">{{$Municipios->links()}}</div>
	</div>
</div>
@endsection