...
<div class="card card-secondary">
    ...
    <div class="card-body">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$municipio->departamento_id}} - {{$departamento->nombre}}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td>{{$municipio->users_id}} - {{$auditoria->email}}</td>
                        </tr>
                        <tr>
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('municipio.index')}}" class="btn btn-secondary" role="button" aria-label="Regresar">
                    {{'Regresar'}}
                </a>
            </div>
        </div>
