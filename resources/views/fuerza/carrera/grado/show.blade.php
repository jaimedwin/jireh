...
<div class="card card-secondary">
    ...
    <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>{{$grado->users_id}} - {{$auditoria->email}}</td>
                        </tr>
                        <tr>
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('fuerza.carrera.grado.index', [$fuerza_id, $carrera_id])}}" class="btn btn-secondary" role="button" aria-label="Regresar">
                    {{'Regresar'}}
                </a>
            </div>
        </div>
