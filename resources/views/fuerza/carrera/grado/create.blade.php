...
<div class="card card-secondary">
	...
	<form action="{{ route('fuerza.carrera.grado.store', [$fuerza_id, $carrera_id])}}" method="post">
			...
			<div class="row">
    			<div class=" col-12 table-responsive">
					...
					<div class="form-group">
						...
						<input id="carrera_id" class="form-control" type="hidden" name="carrera_id" value="{{$carrera_id}}">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card-footer clearfix">
			<a href="{{route('fuerza.carrera.grado.index', [$fuerza_id, $carrera_id])}}" class="btn btn-secondary" role="button"
